      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-purple-500/[0.06] border border-purple-500/20 rounded-2xl p-6 mb-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-[#7a6aa8]">Generated by Claude · plain English</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          {[
            { title: 'Accessibility Issues', items: accessibilityIssues },
            { title: 'Security Issues', items: securityIssues },
          ].map(({ title, items }) => (
