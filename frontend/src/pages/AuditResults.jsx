      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-blue-500/[0.06] border border-blue-500/20 rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3 flex-shrink-0">
            ...
            <button onClick={() => navigate('/settings')} className="bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition-colors">Schedule → Every 6hrs</button>
          </div>
        </div>
